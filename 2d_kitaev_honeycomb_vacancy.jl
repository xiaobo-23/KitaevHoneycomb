...
let
  ...
  for b in lattice
    ...
    if b.s1 == site_to_delete || b.s2 == site_to_delete
  ...
  # Compute the eigenvalue of the order parameter near the vacancy
  ...
  println("")
  println("Eigenvalues of the twelve-point correlator near the vacancy:")
