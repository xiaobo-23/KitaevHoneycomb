...
let
  ...
  h5open("/pscratch/sd/x/xiaobo23/TensorNetworks/non_abelian_anyons/kitaev/magnetic_fields/vacancy/extraction/Armchair/epsilon1E-10/W4/FM_Refine/field_file/configuration_file/data/2d_kitaev_honeycomb_lambda$(eta).h5", "w") do file
    write(file, "psi", ψ)
